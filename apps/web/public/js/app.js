...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof setupAutoModalDetection === 'function') {
        const modalObserver = setupAutoModalDetection();
        window.modalObserver = modalObserver; // Salvar globalmente para debug
    }
    ...
    if (typeof setupGlobalModalEventDelegation === 'function') {
        ...
        console.log('✅ [INIT] Delegação global de eventos configurada como backup!');
    }
...
// Debug: Confirmar que as funções foram exportadas globalmente:
